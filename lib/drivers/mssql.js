...
var columnsSql = fs.readFileSync (path.join (__dirname, 'mssql/columns.sql')).toString ();
var indexesSql = fs.readFileSync (path.join (__dirname, 'mssql/indexes.sql')).toString ();
//var fkeysSql   = fs.readFileSync (path.join (__dirname, 'mssql/fkeys.sql')).toString ();
