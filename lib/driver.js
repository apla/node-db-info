...
//	}
	...
	if (!this.connection) {
		return this.driverConnect (opts || this.connParams, function (err) {
...
Driver.prototype.doSingleQuery = function (query, bindings, options, cb) {
	...
	if (!this.connection) {
		return this.driverConnect (this.connParams, function (err) {
			if (err) return cb (err);
...
Driver.prototype.driverConnect = function (opts, cb) {
	...
	this.connect (opts, function (err, connection) {
